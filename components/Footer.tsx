...
export default function Footer() {
  return (
    <footer className="text-center sm:h-20 w-full sm:pt-2 pt-4 border-t mt-2 flex sm:flex-row flex-col justify-evenly items-center px-3 space-y-3 sm:mb-0 mb-3">
      <div>
        Powered by{" "}
        <a
